<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="BannerMaster.aspx.cs" Inherits="Admin_BannerMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style8">
        <tr>
            <td colspan="4" style="font-size: x-large; font-weight: 700">BANNER MASTER</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                ...
                <asp:GridView ID="gvwBanner" runat="server" AutoGenerateColumns="False" Width="100%" PageSize="100" AllowPaging="True" OnPageIndexChanging="gvwBanner_PageIndexChanging">
                    <AlternatingRowStyle BackColor="#8DC73F" />
                    <Columns>
                        <asp:TemplateField HeaderText="SNo">
                            <ItemTemplate>
                                <%#Container.DataItemIndex+1 %>   
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("BannerID") %>' Visible="False"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="5%" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Banner1">
                            <ItemTemplate>                           
                                <table class="auto-style8">
                                    <tr>
                                        <td>
                                            <asp:Image ID="img1" runat="server" Height="179px" Width="96%" ImageUrl='<%# Bind("Img1") %>' />
                                        </td>
                                    </tr>
                        ...
                        <asp:TemplateField HeaderText="Banner2">
                            <ItemTemplate>                           
                                <table class="auto-style8">
                                    <tr>
                                        <td>
                                            <asp:Image ID="img2" runat="server" Height="179px" Width="97%" ImageUrl='<%# Bind("Img2") %>' />
                                        </td>
                                    </tr>
                        ...
                        <asp:TemplateField HeaderText="Banner3">
                            <ItemTemplate>                           
                                <table class="auto-style8">
                                    <tr>
                                        <td>
                                            <asp:Image ID="img3" runat="server" Height="179px" Width="97%" ImageUrl='<%# Bind("Img3") %>' />
                                        </td>
                                    </tr>
