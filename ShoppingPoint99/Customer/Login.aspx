<%@ Page Title="" Language="C#" MasterPageFile="~/mainwebsite.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Customer_Login" %>
    ...
    <div class="col-md-offset-3 col-md-6 logindivmain">
        ...
        <div class="container-fluid contfldmaindivform">
            ...
            <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp">
                ...
                <asp:TextBox ID="txtCMobile" runat="server" CssClass="customer-textbox" autocomplete="off" placeholder="Enter your Mobile Number" onkeypress='return(event.charCode >= 48 && event.charCode <= 57)' MaxLength="10" ValidationGroup="A"></asp:TextBox>
                <asp:Label runat="server" ID="lblotp" Visible="false"></asp:Label>

            </div>
            <div class="col-xs-offset-2 col-xs-8 logincol12frmgrp">

                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCMobile" CssClass="validation" Display="Dynamic" ErrorMessage="Enter your Mobile number" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtCMobile" CssClass="validation" Display="Dynamic" ErrorMessage="Enter a valid Mobile Number" SetFocusOnError="True" ValidationExpression="^[6-9]\d{9}$" ValidationGroup="A"></asp:RegularExpressionValidator>
            ...
            <asp:Panel ID="pnlPass" runat="server" Visible="true">
                <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp">
                    ...
                    <asp:TextBox ID="txtPassword" runat="server" autocomplete="off" TextMode="Password" CssClass="customer-textbox" placeholder="Enter your Password" ValidationGroup="A"></asp:TextBox>

                </div>
                <div class="col-xs-offset-2 col-xs-8 logincol12frmgrp">

                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" CssClass="validation" Display="Dynamic" ErrorMessage="Enter your Password" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>

                </div>
            </asp:Panel>
            <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp" style="align-self: center">


                <asp:Panel ID="pnlGenerateOTP" runat="server" Visible="false">
                    <asp:Button ID="btnGenerateOTP" runat="server" CssClass="customer-button" Text="Next" Width="115px" Height="32px" ValidationGroup="A" OnClick="btnGenerateOTP_Click" />
                </asp:Panel>
            ...
            <asp:Panel ID="pnlVerifyOTP" runat="server" Visible="false">
                <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp">
                    ...
                    <asp:TextBox ID="txtOTP" runat="server" placeholder="Enter your OTP" Font-Size="16px" CssClass="customer-textbox" Width="40%" onkeypress='return(event.charCode >= 48 && event.charCode <= 57)' MaxLength="4"></asp:TextBox>


                    <asp:Button ID="btnVerifyOTP" runat="server" OnClick="btnVerifyOTP_Click" Text="Verify" ValidationGroup="A" CssClass="customer-button" Width="80px" Height="32px" />

                </div>
                <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">

                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtOTP" CssClass="validation" Display="Dynamic" ErrorMessage="Enter your OTP" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator><br />
                ...
                <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp">
                    ...
                    <asp:Button ID="btnResendOTP" runat="server" CssClass="customer-button" Text="Resend OTP" Width="110px" Height="32px" OnClick="btnResendOTP_Click" />
            ...
            <asp:Panel ID="pnlNewPass" runat="server" Visible="false">
                <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp">
                    ...
                    <asp:TextBox ID="txtNewPass" runat="server" CssClass="customer-textbox" TextMode="Password"></asp:TextBox>

                </div>
                <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">

                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtNewPass" CssClass="validation" Display="Dynamic" ErrorMessage="Enter your New Password" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>

                </div>
                <div class="col-xs-offset-2 col-xs-8 form-group logincol12frmgrp">
                    <label>CONFIRM NEW PASSWORD*</label>

                    <asp:TextBox ID="txtNewCPass" runat="server" CssClass="customer-textbox" TextMode="Password"></asp:TextBox>

                </div>
                <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">


                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtNewCPass" CssClass="validation" Display="Dynamic" ErrorMessage="Enter your New Password Again" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
            ...
            <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">
                ...
                <asp:Panel ID="pnlbtnLogin" runat="server" Visible="true" CssClass="loginbtnparent">
                    <asp:Button ID="btnLogin" runat="server" OnClick="btnLogin_Click" Text="Login" ValidationGroup="A" CssClass="customer-button" Height="38px" Width="130px" />
                </asp:Panel>

            </div>
            <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">

                <asp:Panel ID="pnlbtnLoginNewPass" runat="server" Visible="false" CssClass="loginbtnparent">
                    <asp:Button ID="btnLoginNewPass" runat="server" CssClass="customer-button" Height="38px" OnClick="btnLoginNewPass_Click" Text="Login" ValidationGroup="A" Width="130px" />
                </asp:Panel>
            ...
            <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">
                ...
                <asp:Panel ID="pnlLinkBtnForgetPass" runat="server" Visible="true" CssClass="forgotparent">
                    <asp:LinkButton ID="lbtnForgetPass" runat="server" Style="font-size: large" OnClick="lbtnForgetPass_Click">Forget Password</asp:LinkButton>
                </asp:Panel>
            ...
            <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">
                ...
                <asp:Panel ID="pnlLinkBtnRememberPass" runat="server" Visible="false">
                  
                     <div class="auto-style12 notregdiv">
                     <asp:LinkButton ID="lbtnSignIn" runat="server" OnClick="lbtnSignIn_Click" Font-Size="Large">Remember Password Sign In!</asp:LinkButton>
            ...
            <div class="col-xs-offset-2 col-xs-8  logincol12frmgrp">
                ...
                <div class="auto-style12 notregdiv">
                    Not Registered
                                <asp:LinkButton ID="lbtnSignUp" runat="server" OnClick="lbtnSignUp_Click" Style="font-size: large">Sign Up !</asp:LinkButton>

                </div>

            </div>
            <%--<p class="auto-style13"  style="font-size:12px;">*Fields are Mandatory</p>--%>
        </div>
