...
public partial class Website_ShowCategory : System.Web.UI.Page
{
    ...
    public void showProductDataList()
    {
        ...
        {
            lblCId.Text = Request.QueryString["CategoryID"].ToString();

            SqlCommand cmd = new SqlCommand("exec getCatgryProduct '" + lblCId.Text + "';", con);
    ...
    protected void btnbuynow_Click(object sender, EventArgs e)
    {
        ...
        if (Session["UniqueNumber"] == null)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (status == "Success")
                {
                    //Response.Write("<script>alert('ProceedToPay')</script>");
                    Response.Redirect("~/Website/ProceedToPay.aspx");
                    //?CategoryID=" + lblCId.Text + "")
                }
